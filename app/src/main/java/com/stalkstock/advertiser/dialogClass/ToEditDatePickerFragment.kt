...
class ToEditDatePickerFragment: DialogFragment() , DatePickerDialog.OnDateSetListener {

    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        var tvFromDates = requireActivity().findViewById<TextView>(R.id.cStartDate)
    ...
    override fun onDateSet(view: DatePicker?, year: Int, month: Int, dayOfMonth: Int) {
        var tvEndDate = requireActivity().findViewById<TextView>(R.id.cEndDate)
       var month = month+1
